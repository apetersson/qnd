...
- [ ] #2 The player view shows the synchronized board, both names and scores, whose turn it is, connectivity, timeout strikes, and a prominent countdown derived from the authoritative deadline using the shared server-time calibration
