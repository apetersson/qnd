...
- [ ] #2 During play the route shows a projection-scale 7-by-6 board, player names, scores, turn color, five-second countdown, timeout strikes, winning cells, and next-round countdown while retaining a smaller QR code
